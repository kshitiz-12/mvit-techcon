...
const faqs: FAQItem[] = [
  {
    ...
    answer: (
      <>
        The last date for full paper submission is{' '}
        ...
        . All papers must be submitted via the Microsoft CMT portal before the deadline.
      </>
    ),
  },
...

  {
    ...
    answer:
      'The conference follows a triple-blind peer review process managed by the Technical Program Committee. Each paper receives a minimum of three reviews plus a meta-review before the final decision.',
  },

  {
    question: 'What are the registration fees?',
    answer:
      'Registration fees vary based on the category (IEEE member, non-member, student). Please visit the Registration Fees page for detailed pricing information.',
  },

  {
    question: 'When will I receive acceptance notification?',
    answer:
      'Authors will be notified of paper acceptance decisions on 15th October 2026. Notification emails will be sent to the corresponding author.',
  },

  {
    question: 'Is the conference in-person or virtual?',
    answer:
      'FESCIS 2026 is planned as an in-person only conference to be held at Sir M. Visvesvaraya Institute of Technology, Bengaluru. Please check the website for any updates.',
  },

  {
    question: 'When is the final paper submission deadline?',
    answer:
      'Final paper submission is due on 22nd October 2026. Detailed camera-ready submission instructions will be provided after acceptance.',
  },

  {
    question: 'Will visa support letters be provided?',
    answer:
      'Yes, visa support letters will be issued within five working days after author registration is confirmed. Contact the registration desk for assistance.',
  },

  {
    question: 'What topics are covered in the conference?',
    answer:
      'The conference covers topics including Future Electronics, Sustainable Computing, Intelligent Systems, AI, IoT, Wireless Communication, Data Science, Cybersecurity, and more. See the Paper Submission page for complete track listings.',
  },

  {
    question: 'Can I present multiple papers?',
    answer:
      'Yes, you can submit and present multiple papers. Each paper requires separate registration and payment by at least one author.',
  },
]
            ...
            >
              ...
              >
                <div className="flex items-start gap-3 flex-1">
                  ...
                  {/* Question */}
                  <span
                    className={`font-semibold text-slate-900 sm:text-lg leading-relaxed ${
